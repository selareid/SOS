module.exports = () => {
    ...
    console.logTickSummary = function () {
        console.log(timeString + 'Tick Ended ' + 'CPU: ' + Game.cpu.getUsed().toFixed(3) + ' Processes Run: ' + global.processesRun/global.processesTotal*100 + '% Creeps: ' + _.size(Game.creeps));
    };
