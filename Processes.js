...
module.exports = {
    ...
    room: {
        ...
        spawn: function (Memory_it) {
            ...
            var nextToSpawn = _.sortBy(room.memory.spawnQueue, (c) => {
                return c.proc == 'doHarvest' ? 0 : c.proc == 'fillSpawn' ? 1 : c.proc == 'strgDistr' ? 2 : c.proc == 'fillExt' ? 3 : c.proc == 'claim' ? 4 : 5;
            })[0];
    ...
    fillExt: {
        path: [{x: -1, y: 1}, {x: -1, y: 1}, {x: -1, y: 1}, {x: -1, y: 1}, {x: -1, y: -1}, {x: -1, y: -1},
            {x: 1, y: -1},
            {x: -1, y: 1},
            {x: -1, y: -1}, {x: -1, y: -1},
        ...
        getCreepAmount: function (room) {
            ...
            else return room.controller.level < 8 && room.storage.store.energy > 200000 ? 4 : 2;
        },
