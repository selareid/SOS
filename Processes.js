...
//             }
        ...
        spawn: function (Memory_it) {
            ...
            var nextToSpawn = _.sortBy(room.memory.spawnQueue, (c) => {
                return c.proc == 'doHarvest' || c.proc == 'guards' || c.proc == 'defendRoom' ? 0 : c.proc == 'fillSpawn' ? 1 : c.proc == 'strgDistr' ? 2 : c.proc == 'fillExt' ? 3 : c.proc == 'claim' ? 4 : c.proc == 'praiseRC' && room.controller.ticksToDowngrade*2 >= CONTROLLER_DOWNGRADE && room.controller.progress < room.controller.progressTotal ? 6 : c.proc == 'doLabs' ? 7 : 5;
            })[0];
    ...
    doLabs: {
        ...
        fillLabs: function (creep, room, lab1, lab2, mineral1, mineral2) {
            ...
            if (mineralAmountNeeded < 1 || (!room.storage.store[mineralNeeded] && !room.terminal.store[mineralNeeded] && !creep.carry[mineralNeeded])) return creep.memory.lf = undefined;
