    ...
    doLabs: {
        ...
        run: function (Memory_it) {
            ...
            if (!Memory.mineral1 || !Memory.mineral2) {
                ...
                if (!newMinerals[1] || !newMinerals[2]) return {response: 'idle', time: Game.time + 301};
            ...
            if (creep.memory.w == true) {
                ...
                for (let resourceType in room.storage.store) {
                    if (resourceType == RESOURCE_ENERGY) {
                        ...
                        amountToMove = room.storage.store[resourceType]-500 > 0 ? room.storage.store[resourceType]-500 : undefined;
                        resourceToMove = resourceType;
                        break;
                    }
                }
