...
module.exports = {
    ...
    strgDistr: {
        run: function (Memory_it) {
            ...
            //get more creeps
            if (creeps.length < 1 || (Game.creeps[creeps[0]] && Game.creeps[creeps[0]].ticksToLive < 250 && creeps.length < 2)) Memory.crps.push(module.exports.room.addToSQ('room:' + room.name, 'strgDistr'));
        },
