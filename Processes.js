...
//             }
        ...
        spawn: function (Memory_it) {
            ...
            var nextToSpawn = _.sortBy(room.memory.spawnQueue, (c) => {
                ...
                return c.proc == 'doHarvest' || c.proc == 'guards' || c.proc == 'defendRoom' ? 0 : c.proc == 'fillSpawn' ? 1 : c.proc == 'strgDistr' ? 2 : c.proc == 'fillExt' ? 3 : c.proc == 'claim' ? 4 : c.proc == 'praiseRC' && room.controller.ticksToDowngrade*2 >= CONTROLLER_DOWNGRADE && room.controller.progress < room.controller.progressTotal ? 6 : c.proc == 'doLabs' ? 7 : c.proc == 'scout' ?  8 : 5;
            })[0];
