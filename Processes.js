    ...
    room: {
        ...
        spawn: function (Memory_it) {
            ...
            var nextToSpawn = _.sortBy(room.memory.spawnQueue, (c) => {
                return !c.body.cost || c.body.cost > room.energyCapacityAvailable ? 10: c.proc == 'doHarvest' ? 0 : c.proc == 'fillSpawn' ? 1 : c.proc == 'strgDistr' ? 2 : c.proc == 'fillExt' ? 3 : c.proc == 'claim' ? 4 : c.proc == 'praiseRC' ? 6 : 5;
            })[0];
